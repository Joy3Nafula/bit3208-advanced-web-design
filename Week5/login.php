...
<body>
    <div class="container">
        ...
        if(isset($_GET['error'])) {
            $error = $_GET['error'];
            if($error == 'empty') {
                echo '<div class="alert alert-error">❌ Email and password are required</div>';
            } elseif($error == 'invalid') {
                echo '<div class="alert alert-error">❌ Invalid email or password</div>';
            } elseif($error == 'notfound') {
                echo '<div class="alert alert-error">❌ Email not found. <a href="register.html" class="link">Register here</a></div>';
            }
        }
        ?>
