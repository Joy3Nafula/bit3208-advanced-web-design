...
if(mysqli_query($conn, $query)) {
    echo "<div style='background:#e8f5e9; padding:20px; font-family:Arial; max-width:500px; margin:50px auto; border-radius:10px; text-align:center;'>
            ...
            <a href='login.php' style='display:inline-block; margin-top:20px; background:#667eea; color:white; padding:10px 30px; text-decoration:none; border-radius:5px;'>Go to Login →</a>
          </div>";
} else {
